...
class CleaningRequest(models.Model):
    ...
    support_team_ids = fields.Many2many('res.user',
                                        string="Support Team",
    ...
    head_id = fields.Many2one('res.user', string="Head",
    ...
    assigned_id = fields.Many2one('res.users', string="Assigned To",
                                  help="The team member to whom the request is"
                                       "Assigned To")
    team_member_ids = fields.Many2many('res.user', compute='_compute_team_member_ids', store=False,
